...
public class TestSteps {
    ...
    public void test(String description, String URL, String requestMethod, String headerKeys,
                     ...
                     String JsonKeys, String values, String DataTypes, String waitPeriod,
                     String dbUrl, String dbUsername, String dbPassword, String dbQuery) throws Exception {
        ...
        if (requestMethod.equalsIgnoreCase("DATABASE_QUERY")) {
            previousJsonResponse.add(Step, null);

            dbUrl = ParsingTestData.getAllString(dbUrl, previousJsonResponse, globalVarsData, Step, uniqueIdPerExecution);
            dbUsername = ParsingTestData.getAllString(dbUsername, previousJsonResponse, globalVarsData, Step, uniqueIdPerExecution);
            dbPassword = ParsingTestData.getAllString(dbPassword, previousJsonResponse, globalVarsData, Step, uniqueIdPerExecution);
            dbQuery = ParsingTestData.getAllString(dbQuery, previousJsonResponse, globalVarsData, Step, uniqueIdPerExecution);

            JDBCManager jdbcManager = new JDBCManager(dbUrl, dbUsername, dbPassword);
            jdbcManager.executeQuery(dbQuery);
        } else {
